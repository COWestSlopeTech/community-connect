...
const usergivesController = require('./controllers/usergives');
...
app.get('/relationships', relationshipsController.index);
...
app.get('/usergives', usergivesController.getUsergives);
app.post('/usergives', usergivesController.postUsergives);
